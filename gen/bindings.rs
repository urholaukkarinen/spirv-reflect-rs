...
pub const SPV_VERSION: u32 = 66816;
pub const SPV_REVISION: u32 = 4;
...
pub type SpvRayFlagsShift_ = i32;
...
pub const SpvRayQueryIntersection__SpvRayQueryIntersectionMax: SpvRayQueryIntersection_ =
    2147483647;
pub type SpvRayQueryIntersection_ = i32;
...
pub type SpvRayQueryCommittedIntersectionType_ = i32;
...
pub type SpvRayQueryCandidateIntersectionType_ = i32;
...
pub const SpvFragmentShadingRateShift__SpvFragmentShadingRateMax: SpvFragmentShadingRateShift_ =
    2147483647;
pub type SpvFragmentShadingRateShift_ = i32;
...
pub type SpvFragmentShadingRateMask_ = i32;
...
pub const SpvOp__SpvOpFunctionPointerINTEL: SpvOp_ = 5600;
...
pub type SpvReflectVariableFlagBits = i32;
...
extern "C" {
    ...
    #[doc = "the interface variables for the first one."]
    #[doc = "@param  p_module      Pointer to an instance of SpvReflectShaderModule."]
    #[doc = "@param  p_count       If pp_variables is NULL, the module's interface variable"]
    #[doc = "count will be stored here."]
    #[doc = "If pp_variables is not NULL, *p_count must contain"]
    #[doc = "the module's interface variable count."]
    #[doc = "@param  pp_variables  If NULL, the module's interface variable count will be"]
    #[doc = "written to *p_count."]
    #[doc = "If non-NULL, pp_variables must point to an array with"]
    #[doc = "p_count entries, where pointers to the module's"]
    #[doc = "interface variables will be written. The caller must not"]
...
extern "C" {
    ...
    #[doc = "@brief  Enumerate the interface variables for a given entry point."]
    #[doc = "@param  entry_point The name of the entry point to get the interface variables for."]
    #[doc = "@param  p_module      Pointer to an instance of SpvReflectShaderModule."]
    #[doc = "@param  p_count       If pp_variables is NULL, the entry point's interface variable"]
    #[doc = "count will be stored here."]
    #[doc = "If pp_variables is not NULL, *p_count must contain"]
    #[doc = "the entry point's interface variable count."]
    #[doc = "@param  pp_variables  If NULL, the entry point's interface variable count will be"]
    #[doc = "written to *p_count."]
    #[doc = "If non-NULL, pp_variables must point to an array with"]
    #[doc = "p_count entries, where pointers to the entry point's"]
    #[doc = "interface variables will be written. The caller must not"]
